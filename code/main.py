...
mydb = sqlite3.connect('smart_voting_system')
...
def voting():
    if request.method=='POST':
        pkl_file = open('C:\\Users\\user\\OneDrive\\Desktop\\face\\Smart-Voting-System-main\\code\\encoder.pkl', 'rb')
        my_le = pickle.load(pkl_file)
        pkl_file.close()
        recognizer = cv2.face.LBPHFaceRecognizer_create() # cv2.createLBPHFaceRecognizer()
        recognizer.read("C:\\Users\\user\\OneDrive\\Desktop\\face\\Smart-Voting-System-main\\code\\Trained.yml")
        cam=cv2.VideoCapture(0, cv2.CAP_DSHOW)
